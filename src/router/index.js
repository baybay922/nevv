...
const mainRoutes = {
  ...
  children: [
    ...
    { path: '/event', component: _import('modules/nevv/event'), name: 'event', meta: { title: 'Event List' ,isTab: true} },
    { path: '/prize', component: _import('modules/nevv/prize'), name: 'prize', meta: { title: 'Prize List' ,isTab: true} },
    { path: '/ranking', component: _import('modules/nevv/ranking'), name: 'ranking', meta: { title: 'Leaderboard List' ,isTab: true} },
