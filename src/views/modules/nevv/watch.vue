<template>
	...
	<el-table class="userTable" border :data="dataList" highlight-current-row v-loading="listLoading">
		...
		<el-table-column prop="email" label="Image"></el-table-column> 
		<el-table-column prop="email" label="Play URL"></el-table-column> 
		<el-table-column prop="email" label="Banner"></el-table-column> 
